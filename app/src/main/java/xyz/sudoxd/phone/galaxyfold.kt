...
class galaxyfold : AppCompatActivity() {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_galaxyfold)
    }
    ...
    fun gotogalaxyfoldwebpage(view: View) {
        goToUrl("https://www.samsung.com/au/smartphones/galaxy-fold/")
